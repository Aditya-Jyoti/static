  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen">
      <div className="flex items-center justify-center">
        <h1 className="text-4xl font-bold text-center mb-18 text-white" 
            style={{ 
      ...
      {sections.map((section, index) => (
        <div key={index} className="w-screen min-h-screen max-w-4xl mb-10 lg:hidden text-center">
          <h2 className="text-3xl font-semibold text-white mb-6">{section}</h2>
