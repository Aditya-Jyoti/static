...
const Startup = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center mx-6 sm:mx-12 md:mx-24 ">
      <div className="flex items-center justify-center">
        <h1 className="md:text-7xl text-4xl font-bold">Our Startups</h1>
      </div>
      ...
      {sections.map((section, index) => (
        <div
          key={index}
          className="w-full max-w-4xl mb-10 lg:hidden text-center"
        >
          <h2 className="text-3xl font-semibold text-[#B796FE] mb-6">
            {section}
          </h2>
