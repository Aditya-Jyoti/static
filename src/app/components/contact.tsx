...
const Contact = () => {
    ...
    useEffect(()=>{
        document.getElementById("credits")?.setHTMLUnsafe(`<!-- Made with love by shashwat mishra, aditya jyoti, reuben philip, aryan kumar, shriansh, shivzee, saideep, trisha, preksha -->`);
    } , [])
  ...
  return (
        ...
        <div className="container px-6 py-12 mx-auto">
            <div className="text-center">
                <p className="font-medium text-white dark:text-white">Contact us</p>
            ...
            <div className="grid grid-cols-1 gap-12 mt-10 md:grid-cols-2 lg:grid-cols-3">
                <div className="flex flex-col items-center justify-center text-center">
                    ...
                    <a href='mailto:director.vnest@vit.ac.in' className="mt-2 text-white dark:text-white">director.vnest@vit.ac.in</a>
                </div>
                ...
                <div className="flex flex-col items-center justify-center text-center">
                    ...
                    <Link target='_blank' href='https://maps.app.goo.gl/JrvbiFtJSPrauot29' className="mt-2 text-white dark:text-white">V-NEST Office, AB-3 Ground Floor, VIT Chennai</Link>
                    <Link target='_blank'  href='https://maps.app.goo.gl/JrvbiFtJSPrauot29'>Tamil Nadu - 600127</Link>
                </div>
                ...
                <div className="flex flex-col items-center justify-center text-center">
                    ...
                    <p className="mt-2 text-white dark:text-white">Mobile: +91 99620 00640</p>
                    <p className="mt-2 text-white dark:text-white">Office: +91 44 3993 1063/1143</p>
                </div>
            </div>
        </div>
    </section>
